...
//FUNCOES TIPO INT
int comecarPrimeiro(tipo_Peca pecas[28], int pecasJogador[21], int pecasComp[21], int pecasCompra[14], int pecasMesa[56], int *PvalorEsquerda, int *PvalorDireita);      // Decide qual jogador comeca primeiro de acordo com as regras de inicio de jogo.
